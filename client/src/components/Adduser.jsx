...
const Adduser = () => {
  ...
  return (
    <>
      <Nav />
      <section className="relative bg-form bg-cover bg-center min-w-full min-h-full md:p-10">
        <div className="md:rounded-2xl bg-white min-h-full w-full md:w-2/3  mx-auto md:shadow-lg md:shadow-gray-400/90 md:p-8">
          {greeting === "" && (
            <h1 className="text-4xl font-palanquin font-bold text-center mb-6">
              {" "}
              Generate Your <span className="text-[#007bff]">SOP</span> Now! 🍁
            </h1>
          )}
          {greeting && (
            <h1 className="text-4xl font-palanquin font-bold text-center mb-6">
          ...
          {!isloading && isGen && (
            <div className="flex flex-col text-2xl p-5">
              <button
                onClick={() => navigate("/")}
                className="text-white bg-gradient-to-tr from-blue-400 to-blue-950 rounded-md h-12 w-fit px-4 hover:scale-105 hover:shadow-md hover:shadow-blue-700/80 mx-auto"
              >
                Go to Home
              </button>
            </div>
          ...
          {!isloading && !isGen && (
            <form
              ...
              className="min-w-full h-screen overflow-auto p-5 flex flex-col"
            >
              <div className="w-full mb-4">
                ...
                <input
                  ...
                  className="peer text-lg rounded-md h-10 w-full px-4 border border-green-950 focus:outline-none "
                />
              </div>
              ...
              <div className="w-full mb-4 flex flex-col">
                ...
                <select
                  required
                  name="degree"
                  className="peer rounded-md h-12 px-4 w-2/5 border border-green-950"
                  onChange={(e) => onvalueChange(e)}
                >
              ...
              <div className="w-full mb-4">
                ...
                <input
                  required
                  name="Institute_of_higher_level_education"
                  onChange={(e) => onvalueChange(e)}
                  className="peer text-lg rounded-md h-10 w-full px-4 border border-green-950 focus:outline-none "
                />
              </div>
              ...
              <div className="w-full mb-4">
                ...
                <input
                  ...
                  rows={10}
                  cols={20}
                  className="peer text-lg rounded-md h-10 w-full px-4 border resize border-green-950 focus:outline-none "
                />
              </div>
              ...
              <div className="w-full mb-4">
                ...
                <input
                  required
                  name="program_of_study_in_Canada"
                  onChange={(e) => onvalueChange(e)}
                  className="peer text-lg rounded-md h-10 w-full px-4 border border-green-950 focus:outline-none "
                />
              </div>
              ...
              <div className="mt-4 flex justify-end">
                <button
                  type="submit"
                  className="text-white bg-gradient-to-tr from-blue-400 to-blue-950 rounded-md h-12 w-fit px-4 hover:scale-105 hover:shadow-md hover:shadow-blue-700/80"
                >
                  Submit your details
                </button>
              </div>
